        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
              Streamline Your Blog Tracking
            </h2>
            <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              Discover the powerful features that make our app the ultimate blog
              tracking solution.
            </p>
          </div>
        </div>
        <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <div className="space-y-2 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Submit a blog URL and let our app handle the rest. We&apos;ll
                automatically fetch and analyze new posts.
              </p>
            </div>
          </div>
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <div className="space-y-2 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Get email alerts as soon as new posts are published, so you
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <div className="space-y-2 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Customize your notification settings to receive updates that
                matter most to you.
              </p>
            </div>
          </div>
