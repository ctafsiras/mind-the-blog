    ...
    <section className="w-full py-12 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6">
        <div className="mx-auto max-w-3xl space-y-6 text-center">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">The Benefits of Our App</h2>
          <div className="space-y-4 text-left">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">Never miss an update from your favorite blogs.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <CheckIcon className="mt-1 h-5 w-5 flex-shrink-0 text-green-500" />
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">No need to manually check each blog for new posts.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <CheckIcon className="mt-1 h-5 w-5 flex-shrink-0 text-green-500" />
